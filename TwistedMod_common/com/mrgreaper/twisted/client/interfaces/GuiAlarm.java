...
public class GuiAlarm extends GuiContainer{
	public GuiAlarm(InventoryPlayer invPlayer, TileEntityAlarm alarm) { 
		super(new ContainerAlarm(invPlayer, alarm));
	...
	private static final ResourceLocation texture = new ResourceLocation("twisted", "textures/gui/alarm.png"); // set the resource location
